...
def train():
    ...
    history = model.fit(x_train, y_train, validation_data=(x_test, y_test), batch_size=BATCH_SIZE, epochs=200,
                        shuffle=True,
